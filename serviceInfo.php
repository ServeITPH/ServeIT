...
$averageRatingQuery = "SELECT AVG(ratingValue) FROM ratings WHERE itemID = $serviceInfoID;";
$averageRatingResult = executeQuery($averageRatingQuery);

$feedbackQuery = "SELECT * FROM ratings LEFT JOIN users ON ratings.userID = users.userID WHERE itemID = $serviceInfoID";
                        ...
                        <div class="col-lg-6 d-flex align-items-center text-start">
                            <div class="serviceInfo">
                                ...
                                <div class="price fw-bold">
                                    <span
                                        style="font-size: 32px;">₱<?php echo $serviceInfoRow['price'] ?></span><span>.00</span>
                                </div>
