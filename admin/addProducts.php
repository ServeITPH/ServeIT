...
<body>
    ...
    <div class="col py-5 text-center">
            ...
            <div class="col-md-11 card card-1 m-5 rounded-5">
                    ...
                    <form>
                        <div class="row g-5 d-flex justify-content-center ">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <input type="text" class="form-control rounded-pill" id="tags" placeholder="Enter tags">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="category" class="form-label mt-5">Category</label>
